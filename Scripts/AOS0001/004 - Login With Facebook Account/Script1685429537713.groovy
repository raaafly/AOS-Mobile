...
'TAP BUTTON SIGN IN WITH FACEBOOK'
Mobile.tap(findTestObject('Object Repository/LOGIN_SCREEN/BUTTON_SIGN_IN_WITH_FACEBOOK'), 30, FailureHandling.STOP_ON_FAILURE)
 ...
 */
'ACTUAL RESULT'
Mobile.verifyElementVisible(findTestObject('Object Repository/LOGIN_SCREEN/TOAST/TOAST_403_FORBIDDEN'), 30, FailureHandling.STOP_ON_FAILURE)
